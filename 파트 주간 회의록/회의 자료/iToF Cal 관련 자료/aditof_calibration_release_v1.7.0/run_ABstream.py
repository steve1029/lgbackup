...
def run_test_frames(CalibfolderName, configurationFile):
	test_frames.AB_stream(config_file=configurationFile, CalibfolderName=CalibfolderName)
...
if __name__ == "__main__":
	...
	if len(sys.argv) == 2:
		...
		print('\n\nEnter configurationFile. ex: python run_ABstream.py ./config/CalibrationConfig_Walden.yaml')
		sys.exit()
